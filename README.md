# This fork
This is a fork of Flappuccino, with support of running source out of the box.
I am not the original author of this game (the original author is polymars) but you can use it for non-commercial purposes.
